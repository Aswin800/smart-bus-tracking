...
import { Mail, Lock, Eye, EyeOff, User, Truck, Cpu, Shield } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-[460px] px-8 py-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <button
              type="submit"
              className="w-full py-5 bg-white text-[#020617] font-black text-xs rounded-2xl shadow-3xl hover:bg-yellow-400 transition-all active:scale-[0.98] uppercase tracking-[0.3em] mt-4"
            >
              Initialize Link
            </button>
